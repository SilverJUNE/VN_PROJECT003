...
public class GraphicLayer
{
    ...
    public Coroutine SetVideo(VideoClip video, float transitionSpeed = 1, bool useAudio = true, Texture blendingTexture = null, string filePath = "", bool immediate = false)
    {
